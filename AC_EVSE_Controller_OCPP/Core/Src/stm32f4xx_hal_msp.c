...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA5     ------> ADC1_IN5
    */
    GPIO_InitStruct.Pin = PILOT_ADC1_Pin|PILOT_ADC2_Pin|PROX_ADC1_Pin|PROX_ADC2_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA5     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(GPIOA, PILOT_ADC1_Pin|PILOT_ADC2_Pin|PROX_ADC1_Pin|PROX_ADC2_Pin);
